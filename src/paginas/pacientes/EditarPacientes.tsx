...
export const EditarPacientes = () => {
    const location = useLocation();
    const { user } = UseAuth();
    const navegar = useNavigate();
    
    const pacienteInicial: Paciente = location.state?.paciente || {
        id:0,
        nomeCompleto:'', 
        sexo: '',
        dataNascimento: '',
    ...
    const handleOnClick = async () => {
        ...
        try {
            const response = await fetch('http://localhost:8080/alterarPaciente', {
                method: 'PUT',
                headers: {
        ...
        <div>
            ...
            <div className="p-8 bg-white rounded shadow-md mx-auto mt-10 max-w-4xl">
                <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600">Preencha os campos abaixo para editar o paciente no sistema.</p>
                </div>
                <hr className="mb-6" />
                <div className="mb-4">
